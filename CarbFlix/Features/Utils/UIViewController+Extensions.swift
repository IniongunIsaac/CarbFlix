...
extension UIViewController {
    ...
    func showMovieDetailsViewController(movie: MovieDetail, showAddToFavorites: Bool = true) {
        pushViewController(R.storyboard.movies.movieDetailsViewController()!.apply {
            $0.movie = movie
            $0.showAddToFavorites = showAddToFavorites
        })
    }
