...
extension UIColor {
    ...
    static var primaryColor: UIColor { UIColor("#5d2ece") }
    
    static var primaryColorLight: UIColor { UIColor.primaryColor.withAlphaComponent(0.3) }
    
    static var appGreen: UIColor { UIColor("#00ab80") }
    
    static var appInfo: UIColor { UIColor("#171d46") }
    
    static var appRed: UIColor { UIColor("#EE4848") }
    
    static func cardBackground(traitCollection: UITraitCollection) -> UIColor {
        if #available(iOS 13, *), traitCollection.userInterfaceStyle == .dark {
            return UIColor("#343D5E")
        }
        
        return .white
    }
    
    static func appBackground(traitCollection: UITraitCollection) -> UIColor {
        if #available(iOS 13, *), traitCollection.userInterfaceStyle == .dark {
            return UIColor("#252D4A")
        }
        
        return UIColor("#F2F2F4")
    }
